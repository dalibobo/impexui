...
!function(impex){
    ...
    function eachModel(){
        ...
        this.createSubComp = function(){
            ...
            //直接插入视图
            this.html += '<div>'+this.__view.__nodes[0].innerHTML+'</div>';
            var target = null;
            // this.fragment.appendChild(copy.__nodes[0]);
        ...
        this.build = function(ds,ki,vi){
            ...
            //insert DOM
            var p = this.__view.__nodes[0];
            p.insertAdjacentHTML('afterend', this.html);
